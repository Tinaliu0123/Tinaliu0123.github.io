...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/al-folio/";
          ...
          title: "Tutoring",
          description: "During my undergraduate studies, I had the pleasure of supporting students as a Learning Assistant for these courses.",
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/tutoring/";
          },
        },{id: "nav-misc",
          title: "Misc",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/al-folio/misc/";
          },
